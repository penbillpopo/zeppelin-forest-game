import { E as ExtensionType, U as UPDATE_PRIORITY, T as Ticker, a as EventEmitter, d as deprecation, v as v8_0_0, u as uid, b as definedProps, c as Color, f as Texture, I as ImageSource, D as DOMAdapter, M as Matrix, g as getDefaultExportFromCjs, w as warn, R as Rectangle, m as multiplyHexColors, P as Point, h as earcut, e as extensions, B as BigPool, j as InstructionSet, k as v8_3_4, l as Bounds, n as Cache, o as TexturePool, V as ViewContainer, p as TextureStyle, q as updateQuadBounds, s as nextPow2 } from "./index-af46228a.js";
import { D as DefaultBatcher, G as Geometry, U as UniformGroup, B as BindGroup, R as RendererType, a as Buffer, b as BufferUsage, S as State, c as color32BitToUniform, g as getAdjustedBlendModeBlend, d as getAttributeInfoFromFormat, V as ViewableBuffer, e as Shader, f as GlProgram, h as GpuProgram, i as compileHighShaderGpuProgram, j as compileHighShaderGlProgram, l as localUniformBit, r as roundPixelsBit, k as localUniformBitGl, m as roundPixelsBitGl, n as getMaxTexturesPerBatch, o as colorBit, p as generateTextureBatchBit, q as colorBitGl, s as generateTextureBatchBitGl, t as getBatchSamplersUniformGroup, u as BatchableSprite } from "./colorToUniform-47a85aeb.js";
import { g as getTextureBatchBindGroup, C as CanvasPool } from "./CanvasPool-930b758b.js";
class ResizePlugin {
  /**
...
class Polygon {
  ...
  isClockwise() {
    ...
    for (let i = 0; i < length2; i += 2) {
      const x1 = points[i];
      const y1 = points[i + 1];
      const x2 = points[(i + 2) % length2];
      const y2 = points[(i + 3) % length2];
      area += (x2 - x1) * (y2 + y1);
    }
    return area < 0;
  }
